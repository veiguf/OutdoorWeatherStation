...
plt.grid()
plt.tight_layout()
plt.savefig("/home/veit/Dokumente/OutdoorWeatherStation/Visualization/"+now.strftime("%Y-%m")+"_Temp.svg")
...
plt.grid()
plt.tight_layout()
plt.savefig("/home/veit/Dokumente/OutdoorWeatherStation/Visualization/"+now.strftime("%Y-%m")+"_Hum.svg")
...
plt.grid()
plt.tight_layout()
plt.savefig("/home/veit/Dokumente/OutdoorWeatherStation/Visualization/"+now.strftime("%Y-%m")+"_Rain.svg")
...
plt.title(now.strftime("%B %Y"))
plt.tight_layout()
plt.savefig("/home/veit/Dokumente/OutdoorWeatherStation/Visualization/"+now.strftime("%Y-%m")+"_WindSpeed.svg")
...
plt.title(now.strftime("%B %Y"))
plt.tight_layout()
plt.savefig("/home/veit/Dokumente/OutdoorWeatherStation/Visualization/"+now.strftime("%Y-%m")+"_GustSpeed.svg")
